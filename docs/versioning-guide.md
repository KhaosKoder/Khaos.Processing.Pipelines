...
| Setting | Value |
| --- | --- |
| Tag Prefix | `Khaos.Processing.Pipelines/v` |
| Auto Increment | `minor` |
| Default Pre-release | `alpha.0` |

Example release tag: `Khaos.Processing.Pipelines/v1.4.0`
...
```xml
<PropertyGroup>
  <MinVerTagPrefix>Khaos.Processing.Pipelines/v</MinVerTagPrefix>
